...
if __name__ == "__main__":
    ...
    c_schema = [{"name": "Plot", "max": 100, "min": 0},
                {"name": "Audio-visual Experience", "max": 100, "min": 0},
    ...
    radar.add('The Wandering Earth', value, item_color="#5CACEE",
    ...
    attr = ['故事情节', '视听体验', '人物塑造', '粉丝基础', '商业价值', '主题文化']
    val = [plot, audio_visual, character, fan, commercial, conception]

    pie = Pie("流浪地球-六维饼图", title_pos="left", width=1200, height=600)
